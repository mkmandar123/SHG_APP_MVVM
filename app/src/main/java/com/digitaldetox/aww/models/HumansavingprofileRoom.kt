...
@Parcelize
@Entity(tableName = "humansavingprofile_table")
data class HumansavingprofileRoom(
    ...
    @ColumnInfo(name = "upload_error") var uploadError: String? = null
     ...
     override fun toString(): String {
        return "HumansavingprofileRoom(pk=$pk, title='$title', albumId=$albumId, queuedForUpload=$queuedForUpload, uploadedPercentage=$uploadedPercentage, uploadId=$uploadId, uploadError=$uploadError)"
    }
}