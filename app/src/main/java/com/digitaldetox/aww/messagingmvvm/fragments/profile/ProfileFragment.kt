package com.digitaldetox.aww.messagingmvvm.fragments.profile
...
import com.digitaldetox.aww.databinding.ProfileFragmentBinding
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.your_profile)
