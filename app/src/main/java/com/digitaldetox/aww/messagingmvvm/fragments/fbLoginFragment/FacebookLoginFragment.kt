package com.digitaldetox.aww.messagingmvvm.fragments.fbLoginFragment
...
import com.digitaldetox.aww.databinding.FacebookLoginFragmentBinding
...
import com.digitaldetox.aww.messagingmvvm.util.eventbus_events.CallbackManagerEvent
...
//        try {
//            if (parentFragment?.javaClass.toString() == "class com.digitaldetox.aww.messagingmvvm.fragments.login.LoginMessagingFragment") {
//
//                this@FacebookLoginFragment.findNavController()
//                    .navigate(R.id.action_loginFragment_to_homeFragment)
//            } else if (parentFragment?.javaClass.toString() == "class com.digitaldetox.aww.messagingmvvm.fragments.register.SignupFragment") {
//                this@FacebookLoginFragment.findNavController()
