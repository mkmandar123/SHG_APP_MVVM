package com.digitaldetox.aww.messagingmvvm.fragments.home_group
...
import com.digitaldetox.aww.databinding.HomeFragmentRoomBinding
...
private const val TAG = "HomeFragmentRoom"
class HomeFragmentRoom : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.groups)
