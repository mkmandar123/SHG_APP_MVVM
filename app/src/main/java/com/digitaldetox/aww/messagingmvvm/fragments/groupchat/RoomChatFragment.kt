package com.digitaldetox.aww.messagingmvvm.fragments.groupchat
...
import com.digitaldetox.aww.databinding.ChatFragmentRoomsBinding
import com.digitaldetox.aww.messagingmvvm.models.*
...
import com.digitaldetox.aww.messagingmvvm.util.eventbus_events.PermissionEvent
import com.digitaldetox.aww.messagingmvvm.util.eventbus_events.UpdateRecycleItemEvent
...
private const val TAG = "RoomChatFragment"
class RoomChatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "${clickedGroup.group_name}"
...
//        }
        R.id.action_addmembers -> {
            ...
            findNavController().navigate(
                R.id.action_roomChatFragment_to_addMembersToGroupFragment, bundleOf(
        ...
        R.id.action_information -> {
            ...
            val clickedGroup = gson.toJson(clickedGroup)
            findNavController().navigate(
                R.id.action_roomChatFragment_to_groupInfoFragment, bundleOf(
                    ClICKED_GROUP to clickedGroup
                )
            )
