package com.digitaldetox.aww.messagingmvvm.fragments.home_one_to_one_chat
...
import com.digitaldetox.aww.databinding.HomeFragmentBinding
import com.digitaldetox.aww.messagingmvvm.models.ChatParticipant
import com.digitaldetox.aww.messagingmvvm.models.User
import com.digitaldetox.aww.messagingmvvm.services.MyFirebaseMessagingService
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.chats)
        setHasOptionsMenu(true)
        ...
        //get user data
        homeViewModel.loggedUserMutableLiveData.observe(viewLifecycleOwner, Observer { loggedUser ->
            ...
            homeViewModel.getChats(loggedUser!!)
    ...
    override fun onOptionsItemSelected(item: MenuItem) = when (item.itemId) {
        ...
        R.id.action_group -> {
            findNavController().navigate(R.id.action_homeFragment_to_homeFragmentRoom)
            true
        }
    ...
    override fun onStart() {
        ...
        (activity as MainActivity).bottom_navigation_view.setBackgroundColor(
