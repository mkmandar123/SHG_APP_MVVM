package com.digitaldetox.aww.messagingmvvm.fragments.group_info
...
import com.digitaldetox.aww.databinding.GroupinfoFragmentBinding
import com.digitaldetox.aww.messagingmvvm.fragments.profile.ProfileFragment
import com.digitaldetox.aww.messagingmvvm.fragments.profile.REQUEST_IMAGE_CAPTURE
import com.digitaldetox.aww.messagingmvvm.fragments.profile.SELECT_PROFILE_IMAGE_REQUEST
...
class GroupInfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.group_info)
