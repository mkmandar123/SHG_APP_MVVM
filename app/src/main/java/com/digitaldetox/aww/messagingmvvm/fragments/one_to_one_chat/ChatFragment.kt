package com.digitaldetox.aww.messagingmvvm.fragments.one_to_one_chat
...
import com.digitaldetox.aww.databinding.ChatFragmentBinding
...
class ChatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "Chatting with ${clickedUser.username}"
