...
import com.digitaldetox.aww.fragments.main.account.AccountNavHostFragment
import com.digitaldetox.aww.fragments.main.messagingmvvm.MessagingmvvmNavHostFragment
import com.digitaldetox.aww.fragments.main.root.RootNavHostFragment
import com.digitaldetox.aww.messagingmvvm.util.AuthUtil
import com.digitaldetox.aww.util.BottomNavController.OnNavigationReselectedListener
...
const val BOTTOM_NAV_BACKSTACK_KEY =
    "com.digitaldetox.openapi.util.BottomNavController.bottom_nav_backstack"
...
class BottomNavController(
    ...
    private fun createNavHost(menuItemId: Int): Fragment {
        return when (menuItemId) {
            ...
            R.id.menu_nav_root -> {
                RootNavHostFragment.create(R.navigation.nav_root)
            }

            R.id.nav_menu_messaging ->
                {
                    if (AuthUtil.firebaseAuthInstance.currentUser != null) {
                        MessagingmvvmNavHostFragment.create(R.navigation.nav_graph)

                    } else {
                        MessagingmvvmNavHostFragment.create(R.navigation.nav_auth_messaging)
                    }
                }
